...
$(document).ready(function() {
    if (localStorage.getItem("taskItem")) { // liste localstorage belleğinde varsa oku
        document.getElementById("allTasks").innerHTML = localStorage.getItem("taskItem");
...
const createTask = (currentTask) => {
    document.querySelector("ul").innerHTML +=
        '<li onclick="taskDone(this)">' + currentTask +
        '<span onclick="deleteTask(this.parentNode)"><i class="fa-regular fa-trash-can"></i></span></li>';

    localStorage.setItem("taskItem", document.getElementById("allTasks").innerHTML)
}
...
document.getElementById("clear-all").onclick = () => { clearStorage() }
